...
public class InnerJoinExample {
   ...
   static class OrderParsing extends DoFn<String, KV<String, String>>{
    ...
    static class UserParsing extends DoFn<String,KV<String, String>>{
    ...
    public static void main(String[] args) {
            ...
            PCollection<KV<String,String>> pOrderCollection = p.apply(TextIO.read().from("/Users/rarodriguezl/FalMerchandise/gitlab/ExampleDataFlow/src/main/resources/user_order.csv"))
                    .apply(ParDo.of(new OrderParsing()));

            PCollection<KV<String,String>> pUserCollection = p.apply(TextIO.read().from("/Users/rarodriguezl/FalMerchandise/gitlab/ExampleDataFlow/src/main/resources/p_user.csv"))
            ...
            output.apply(TextIO.write().to("/Users/rarodriguezl/FalMerchandise/gitlab/ExampleDataFlow/src/main/resources/cogroup_by_key.csv").withNumShards(1).withSuffix(".csv"));
            p.run();
